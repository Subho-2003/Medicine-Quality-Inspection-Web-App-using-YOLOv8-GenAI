...
// Assuming these imports point to valid JS/JSX files or libraries
...
// No type definition needed in JS
...
// Removed VariantProps and specific tooltip type
const SidebarMenuButton = forwardRef(
  (
    {
      asChild = false,
      isActive = false,
      variant = "default", // Still needed for cva
      size = "default",   // Still needed for cva
      tooltip,
      className,
      ...props
    },
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size }), className)} // Pass variant/size to cva
        {...props}
      />
    );
    ...
    if (typeof tooltip === "string") {
      ...
      // Assume it's an object with props for TooltipContent
      tooltipProps = tooltip;
    } else {
        // Handle cases where tooltip might be unexpected type or undefined/null after check
       return button; // Or render nothing, or throw error
    }
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          ...
          {...tooltipProps} // Spread the determined tooltip props
        />
      </Tooltip>
    );
  }
...
const SidebarMenuSkeleton = forwardRef(
  ({ className, showIcon = false, ...props }, ref) => {
    // Random width calculation remains the same
    const width = useMemo(() => {
...
const SidebarMenuSubItem = forwardRef(({ ...props }, ref) => (
  <li ref={ref} {...props} /> // Simple li forwarding
));
